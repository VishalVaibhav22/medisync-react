        ...
        {appointments.map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 justify-end">
              ...
              {!item.cancelled && !item.payment && !item.isCompleted && (
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border hover:bg-primary hover:text-white duration-300">
                  Pay Online
                </button>
              )}

              {!item.cancelled && !item.isCompleted && (
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border hover:bg-red-600 hover:text-white duration-300">
                  Cancel Appointment
                </button>
              )}
